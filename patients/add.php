...
<?php include '../config/db.php'; if($_POST){$n=$_POST['nama']; $koneksi->query("INSERT INTO patients(nama) VALUES('$n')"); header('Location: index.php'); } ?>
<form method='post'>Nama: <input name='nama'><button>Simpan</button></form>